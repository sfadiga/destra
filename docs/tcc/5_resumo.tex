...
Os resultados indicam que a abordagem proposta pode contribuir para a inspeção de estados internos do software durante a execução, preservando o comportamento temporal do sistema e oferecendo suporte à validação de requisitos em sistemas embarcados.

\vspace*{5mm}

\noindent
\textbf{Palavras-chave:} sistemas de tempo-real; testes integrados; peek/poke.
