...
% ------------------------------------------------------------------------
\input{0_ficha}
\input{1_folha_aprovacao}
\input{2_dedicatoria}
\input{3_agradecimentos}
\input{4_epigrafe}
\input{5_resumo}
\input{6_abstract}
\newpage
...
% ------------------------------------------------------------------------
\textual
\input{cap1_introducao}      % Capítulo 1
\input{cap2_fundamentacao}   % Capítulo 2 
\input{cap3_desenvolvimento} % Capítulo 3
\input{cap4_testes}          % Capítulo 4
\input{cap5_conclusao}       % Capítulo 5
\input{cap6_referencias}     % Referências bibliográficas
% ------------------------------------------------------------------------
% Elementos pós-textuais
% ------------------------------------------------------------------------
\apendices
\input{apendice_a_codigo_arduino}
\input{apendice_b_ferramenta_host}
\input{apendice_c_protocolo_instrumentado}
\input{apendice_d_testes_performance}
\input{apendice_e_diagrama_classes}
\end{document}
